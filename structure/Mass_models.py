...
def thrust_frame_mass_variable(T,M_eng,n_ax_max,N_eng,k_SM,SSM):
    """
    Calculate thrust frame mass with variable material composition
    k_SM: material factor (1.0 = 100% Al, 0.62 = 100% Composite for thrust frame)
...
# New function with k_SM as parameter for optimization
def mass_interstage_variable(S,D_inf,D_up,U_L,k_SM):
    """
    Calculate interstage mass with variable material composition
    k_SM: material factor (1.0 = 100% Al, 0.7 = 100% Composite for interstage)
    Note: Composite provides 30% mass reduction for interstage (less than thrust frame)
    """
    k_1_1=7.7165
    k_1_2=5.5234
